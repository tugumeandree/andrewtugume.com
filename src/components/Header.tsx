        ...
        <div className="container py-2">
          <div className="flex items-center justify-between text-xs md:text-sm">
            <div className="flex items-center gap-4 md:gap-6">
              <a href="mailto:andrewtugume2@gmail.com" className="flex items-center gap-1.5 text-gray-600 hover:text-primary transition-colors group">
              ...
              <a href="tel:+256755017384" className="flex items-center gap-1.5 text-gray-600 hover:text-primary transition-colors group">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
