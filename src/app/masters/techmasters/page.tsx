    ...
    <div className="space-y-12">
      ...
      <section className="bg-white border border-black/5 rounded-2xl p-8 md:p-12">
        ...
        <p className="mt-4 text-gray-700 max-w-3xl">
          For developers, technical founders, and innovation leaders who want to build real-world solutions with disciplined execution.
        </p>
        <div className="mt-6">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white border border-black/5 rounded-2xl p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-gray-700">
            <li>Product thinking and discovery.</li>
            <li>Systems architecture and technical planning.</li>
            <li>Research and development execution.</li>
            <li>Monetization and scale readiness.</li>
          </ul>
        </div>
      </section>
