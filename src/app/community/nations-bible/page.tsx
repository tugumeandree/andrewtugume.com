  ...
  return (
    <div className="space-y-10">
      <section className="bg-white border border-black/5 rounded-2xl p-8 md:p-12">
        <h1 className="text-4xl md:text-5xl font-semibold text-primary">Nations Community</h1>
        <p className="mt-4 text-gray-700">This community experience has been consolidated into the Mastery Network for cohort members.</p>
        <div className="mt-6">
