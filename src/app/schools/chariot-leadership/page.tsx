  ...
  return (
    <div className="space-y-10">
      <section className="bg-white border border-black/5 rounded-2xl p-8">
        <h1 className="text-3xl md:text-4xl font-semibold text-primary">Chariot Leadership Institute</h1>
        <p className="mt-3 text-gray-700">Leadership development and governance training for teams and executives.</p>
        <div className="mt-6">
